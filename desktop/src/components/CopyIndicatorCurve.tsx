  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          {/* Luminous Screen-Edge Curve SVG */}
          <div className="relative flex items-center">
            <svg
              ...
              className="drop-shadow-[0_0_16px_rgba(99,102,241,0.6)]"
            >
              <path
            ...
            <motion.div
              ...
              className="absolute left-1 w-5 h-5 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white border border-white/40 shadow-sm"
            >
